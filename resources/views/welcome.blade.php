...
<head>
    ...
    <title>{{ config('app.name', 'School CMS') }}</title>
    ...
    <main class="flex-1">
        <section class="relative h-[80vh] min-h-[500px] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-20 text-center max-w-3xl mx-auto px-5">
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">Welcome to School CMS</h1>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="{{ route('about') }}" class="inline-flex items-center px-8 h-12 text-base font-medium text-white border-2 border-white/30 rounded-xl hover:bg-white/10 transition-colors">Learn More</a>
        ...
        <section class="bg-academic-blue">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6 py-8 lg:py-10">
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    <div class="text-center"><p class="text-3xl lg:text-4xl font-bold text-white">25+</p><p class="text-sm text-white/70 mt-1">Years of Excellence</p></div>
                    <div class="text-center"><p class="text-3xl lg:text-4xl font-bold text-white">500+</p><p class="text-sm text-white/70 mt-1">Students Enrolled</p></div>
                    <div class="text-center"><p class="text-3xl lg:text-4xl font-bold text-white">50+</p><p class="text-sm text-white/70 mt-1">Qualified Teachers</p></div>
                    <div class="text-center"><p class="text-3xl lg:text-4xl font-bold text-white">100%</p><p class="text-sm text-white/70 mt-1">Pass Rate</p></div>
                </div>
            </div>
        </section>
        ...
        <section class="py-12 lg:py-24">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6">
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    <div><div class="w-48 h-48 lg:w-56 lg:h-56 rounded-full bg-light-gray mx-auto lg:mx-0 flex items-center justify-center text-muted text-sm border border-border">Photo</div></div>
                    <div>
                        <h2 class="text-2xl lg:text-4xl font-bold text-academic-blue mb-4">Principal's Message</h2>
                        <p class="text-base lg:text-lg text-slate-dark/70 leading-relaxed mb-6">Welcome to School CMS, where we believe in nurturing every student's potential through quality education, character development, and a supportive learning environment.</p>
        ...
        <section class="py-12 lg:py-24 bg-light-gray">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6">
                <div class="flex items-center justify-between mb-8 lg:mb-12">
                    <div><h2 class="text-2xl lg:text-4xl font-bold text-academic-blue">Latest Notices</h2><p class="text-muted mt-1">Stay informed with the latest announcements</p></div>
        ...
        <section class="py-12 lg:py-24">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6">
                <div class="flex items-center justify-between mb-8 lg:mb-12">
                    <div><h2 class="text-2xl lg:text-4xl font-bold text-academic-blue">Academic Programs</h2><p class="text-muted mt-1">Explore our comprehensive academic offerings</p></div>
                </div>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section class="py-12 lg:py-24 bg-light-gray">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6">
                <div class="flex items-center justify-between mb-8 lg:mb-12">
                    <div><h2 class="text-2xl lg:text-4xl font-bold text-academic-blue">Our Facilities</h2><p class="text-muted mt-1">State-of-the-art facilities for comprehensive learning</p></div>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
                    ...
                    <div class="bg-white border border-border rounded-2xl p-6 text-center">
                        <div class="w-10 h-10 rounded-lg bg-academic-blue/10 flex items-center justify-center mx-auto mb-3">
                            <svg class="w-5 h-5 text-academic-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        </div>
                    ...
                    <div class="bg-white border border-border rounded-2xl p-6 text-center">
                        <div class="w-10 h-10 rounded-lg bg-academic-blue/10 flex items-center justify-center mx-auto mb-3">
                            <svg class="w-5 h-5 text-academic-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                        </div>
                        <span class="text-sm font-medium text-slate-dark">Sports</span>
                    </div>
                    <div class="bg-white border border-border rounded-2xl p-6 text-center">
                        <div class="w-10 h-10 rounded-lg bg-academic-blue/10 flex items-center justify-center mx-auto mb-3">
                            <svg class="w-5 h-5 text-academic-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        </div>
                        <span class="text-sm font-medium text-slate-dark">Hostel</span>
                    </div>
                    <div class="bg-white border border-border rounded-2xl p-6 text-center">
                        <div class="w-10 h-10 rounded-lg bg-academic-blue/10 flex items-center justify-center mx-auto mb-3">
                            <svg class="w-5 h-5 text-academic-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        </div>
        ...
        <section class="bg-academic-blue">
            <div class="max-w-[1280px] mx-auto px-5 lg:px-6 py-16 lg:py-20 text-center">
                ...
                <p class="text-white/80 mb-8 max-w-lg mx-auto">Have questions about admissions, academics, or anything else? We're here to help.</p>
