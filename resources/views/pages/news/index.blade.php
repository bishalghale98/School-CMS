...
@section('content')
    ...
    <section class="py-12 lg:py-24">
        <div class="max-w-[1280px] mx-auto px-5 lg:px-6">
            @if ($featured)
                <div class="mb-10">
                    <div class="relative rounded-2xl overflow-hidden bg-light-gray">
                        <div class="md:flex">
                            ...
                            <div class="md:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                                ...
                                <h2 class="text-2xl lg:text-3xl font-bold text-slate-dark mb-3">
                                    <a href="{{ route('news.show', $featured->slug) }}" class="hover:text-academic-blue transition-colors">{{ $featured->title }}</a>
                                </h2>
